...
// кастомный линк можно теперь передать в элемент и применить его к линкам
// import { CustomLink} from './CustomLink'

const activeLink = ({isActive})=> isActive ? 'active-link' : '';
// Так же можно стилизовать ссылки черех style НО незабываем что функция передаётся в style ф не в ClassName, потому что style вернёт объект
